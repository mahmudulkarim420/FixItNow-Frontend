...
import { HelpCircle, PhoneCall, MessageSquare, ExternalLink } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="rounded-3xl border border-stone-200/80 bg-white p-5 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-base font-bold text-stone-900">24/7 Customer Hotline</h3>
        ...
        <div className="rounded-3xl border border-stone-200/80 bg-white p-5 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-base font-bold text-stone-900">Satisfaction Guarantee</h3>
            <p className="mt-1 text-xs font-medium text-stone-500">
