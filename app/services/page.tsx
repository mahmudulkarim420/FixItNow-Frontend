    ...
    <div className="min-h-screen bg-[#F9F7F2] dark:bg-slate-950 text-stone-900 dark:text-slate-100 selection:bg-amber-200 selection:text-amber-950 transition-colors duration-200">
      ...
      <main className="pt-20 sm:pt-24">
        ...
        <section className="relative overflow-hidden px-4 pb-12 pt-12 sm:px-6 sm:pb-16 sm:pt-16 lg:px-8 lg:pb-20">
          ...
          <div className="pointer-events-none absolute -right-24 top-0 h-80 w-80 rounded-full bg-amber-300/35 dark:bg-amber-500/10 blur-3xl" />

          <div className="relative mx-auto max-w-7xl">
            <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-12">
              {/* Left Column: Heading & Badge */}
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-2 rounded-full border border-amber-200 dark:border-amber-800 bg-amber-50/90 dark:bg-amber-950/60 px-3.5 py-1.5 text-xs font-bold text-amber-800 dark:text-amber-300 shadow-2xs backdrop-blur-md">
                  <Sparkles className="h-3.5 w-3.5 text-amber-600 dark:text-amber-400" />
                  <span>FixItNow Expert Catalog</span>
                </div>
                <h1 className="mt-5 text-3xl font-extrabold tracking-[-0.04em] text-stone-950 dark:text-slate-100 sm:text-5xl lg:text-6xl lg:leading-[1.08]">
                  Professional Repair & Maintenance Services
                </h1>
                <p className="mt-5 max-w-2xl text-sm leading-7 text-stone-600 dark:text-slate-300 sm:text-base lg:text-lg">
                ...
                <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3">
                  {trustPoints.map(({ icon: Icon, label }) => (
                    <span
                      key={label}
                      className="flex items-center gap-2 text-xs font-semibold text-stone-700 dark:text-slate-300 sm:text-sm"
                    >
              ...
              <div className="relative lg:col-span-5">
                <div className="relative mx-auto aspect-[4/3] w-full max-w-md overflow-hidden rounded-3xl border-4 border-white dark:border-slate-800 bg-white dark:bg-slate-900 shadow-[0_25px_60px_-25px_rgba(41,37,36,0.35)] sm:aspect-[16/11]">
                  <Image
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between rounded-2xl border border-white/40 dark:border-slate-700/60 bg-white/80 dark:bg-slate-900/80 p-3.5 shadow-lg backdrop-blur-md">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-extrabold text-stone-900 dark:text-slate-100">Certified Local Pros</p>
                        <p className="text-[11px] text-stone-600 dark:text-slate-400 font-medium">Licensed, Vetted & Insured</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-1 rounded-lg bg-amber-50 dark:bg-amber-950/60 px-2.5 py-1 text-xs font-bold text-amber-800 dark:text-amber-300">
