...
import { X, Calendar, User, Phone, Wrench, Sparkles } from "lucide-react";
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg overflow-hidden rounded-3xl bg-white p-6 shadow-2xl z-10 max-h-[90vh] overflow-y-auto"
          >
            <div className="flex items-center justify-between border-b border-stone-100 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-extrabold text-stone-900">Create New Booking</h3>
                  <p className="text-xs font-medium text-stone-400">Dispatch a new customer service request</p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-stone-700 mb-1">Customer Email</label>
                <input
                  type="email"
                  value={customerEmail}
              ...
              <div>
                <label className="block text-xs font-bold text-stone-700 mb-1">Select Service</label>
                <select
                  value={service}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold text-stone-700 mb-1">Scheduled Date</label>
                  <input
                    type="date"
                    value={date}
              ...
              <div>
                <label className="block text-xs font-bold text-stone-700 mb-1">Assign Technician</label>
                <select
                  value={technician}
