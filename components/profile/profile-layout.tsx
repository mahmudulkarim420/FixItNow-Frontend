...
export function ProfileLayout({ user, technicianDetails }: ProfileLayoutProps) {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto my-4 sm:my-8 px-2 sm:px-4">
      ...
      <div className="bg-white rounded-3xl border border-stone-200/90 shadow-2xl overflow-hidden flex flex-col lg:flex-row min-h-[640px]">
        
        {/* ================= LEFT SIDEBAR PANEL (DARK STONE BRAND ACCENT) ================= */}
        <div className="w-full lg:w-72 bg-gradient-to-b from-stone-900 via-stone-900 to-stone-950 lg:rounded-l-3xl p-6 lg:p-8 flex flex-col justify-between text-white shrink-0">
          <div>
            {/* Top User Header */}
        ...
        <div className="flex-1 p-6 lg:p-10 bg-white">
          ...
          <div className="mb-8 pb-4 border-b border-stone-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold text-rose-600 hover:text-rose-700 px-3 py-1.5 rounded-xl hover:bg-rose-50 border border-rose-200/80 transition-colors self-start sm:self-auto cursor-pointer"
            >
          ...
          {formSuccess && (
            <div className="mb-6 p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-xs sm:text-sm rounded-2xl border border-stone-200 bg-stone-50/60 focus:bg-white focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 font-semibold text-stone-900 transition-all"
                  />
                </div>
                  ...
                  <>
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full p-4 text-xs sm:text-sm rounded-2xl border border-stone-200 bg-stone-50/60 focus:bg-white focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 font-semibold text-stone-900 transition-all resize-none"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="e.g. 50"
                          className="w-full px-4 py-3 text-xs rounded-2xl border border-stone-200 bg-stone-50/60 focus:bg-white focus:outline-none focus:border-amber-500 font-semibold text-stone-900"
                        />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-stone-600 mb-1.5">
              ...
              <div className="space-y-4 flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-stone-600 mb-1.5">
                      Confirm new password <span className="text-stone-400 font-normal">(optional)</span>
                    </label>
                    <input
                      type="password"
                  ...
                  <div className="mt-6 p-4.5 rounded-2xl bg-stone-50 border border-stone-200/80 space-y-2.5">
                    <div className="flex items-center justify-between text-xs text-stone-600 font-semibold">
                      <span>Account Role</span>
                      <span className="font-extrabold text-stone-900">{user.role}</span>
                    </div>
                    <div className="flex items-center justify-between text-xs text-stone-600 font-semibold">
                      <span>Account Status</span>
                      <span className="font-black text-emerald-600 uppercase text-[10px] bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200">
                        {user.status}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-xs text-stone-600 font-semibold">
                ...
                <div className="pt-6">
                  <button
                    type="submit"
                    disabled={isUpdating}
                    className="w-full py-4 px-6 rounded-2xl bg-amber-500 hover:bg-amber-600 disabled:opacity-60 text-white font-bold text-sm tracking-wide shadow-lg shadow-amber-500/25 transition-all duration-200 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
                  >
                    {isUpdating ? (
      ...
      {isDeleteOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 overflow-y-auto">
          <div className="relative w-full max-w-md rounded-3xl bg-white p-6 sm:p-8 shadow-2xl border border-rose-100 my-8">
            ...
            <form onSubmit={handleDeleteAccount} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="DELETE"
                  className="w-full px-4 py-3 font-mono text-sm rounded-xl border border-stone-300 focus:border-rose-500 focus:outline-none font-bold uppercase text-stone-900"
                />
              </div>
