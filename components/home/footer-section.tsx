      ...
      <div className="mx-auto max-w-7xl px-4 pb-24 pt-12 sm:px-6 sm:pb-12 sm:pt-16 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 py-8 sm:grid-cols-2 lg:grid-cols-5 lg:gap-12 lg:py-12">
          <div className="col-span-2 sm:col-span-2 lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-xs sm:text-sm leading-6 text-stone-500">
            ...
            <div className="mt-4 sm:mt-5 flex gap-2">
              {[Share2, Send].map((Icon, index) => (
                <a key={index} href="#" aria-label="Follow FixItNow" className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-full bg-stone-100 text-stone-600 transition hover:bg-amber-500 hover:text-white">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title} className="col-span-1">
              ...
              <ul className="mt-3 sm:mt-4 space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-stone-500">
          ...
          <div className="col-span-2 sm:col-span-1 lg:col-span-1">
            ...
            <ul className="mt-3 sm:mt-4 space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-stone-500">
              <li><a href="tel:+18005550140" className="flex items-center gap-2 hover:text-amber-700"><Phone className="h-4 w-4 text-amber-600 shrink-0" /> (800) 555-0140</a></li>
              <li><a href="mailto:hello@fixitnow.co" className="flex items-center gap-2 hover:text-amber-700"><Mail className="h-4 w-4 text-amber-600 shrink-0" /> hello@fixitnow.co</a></li>
        ...
        <div className="flex flex-row items-center justify-between gap-3 border-t border-stone-200/80 pt-6 text-[11px] sm:text-xs text-stone-500">
          <p>© {new Date().getFullYear()} FixItNow. All rights reserved.</p>
          <div className="flex gap-4 sm:gap-5"><Link href="#privacy" className="hover:text-stone-900">Privacy</Link><Link href="#terms" className="hover:text-stone-900">Terms</Link></div>
        </div>
      </div>
    </footer>
  );
